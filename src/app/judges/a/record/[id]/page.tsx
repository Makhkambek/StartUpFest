        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-5 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" step="0.01" value={run1} onChange={e => { setRun1(e.target.value); setPen1(0) }}
                placeholder="12.34"
                className="w-full border border-gray-200 rounded-lg px-4 py-3 text-xl font-mono focus:outline-none focus:ring-2 focus:ring-amber-300" />
          ...
          <div>
            ...
            <textarea value={notes} onChange={e => setNotes(e.target.value)} rows={3}
              ...
              className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-300 resize-none" />
          </div>
